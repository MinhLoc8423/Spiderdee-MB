  ...
  const renderEmptyResults = () => (
    <View className="flex-1 justify-center items-center">
      <Image
        ...
        tintColor={"#B3B3B3"}
      />
      <Text className="text-lg font-bold text-gray-800">Không có sản phẩm</Text>
      <Text className="text-base text-gray-600 text-center mx-8">
        Bạn chưa có sản phẩm nào được lưu. Hãy về trang chủ và thêm một số sản phẩm.
      </Text>
    </View>
  );
