...
const NewAddressScreen = () => {
  ...
  const [nickname, setNickname] = useState(addressData.name);
  const [fullAddress, setFullAddress] = useState(addressData.address);
  const [isDefault, setIsDefault] = useState(addressData.isDefault);
  ...
  const handleAddAddress = () => {
    ...
    updateAddress(addressData._id, name, address, isDefault);
  ...
  const handleTouch = () => {
    hanldTurnOnModal(
      ...
      "Vui lòng chọn địa chỉ khác làm địa chỉ mặc định mới.",
      "warning",
      "Đóng"
    );
  };
